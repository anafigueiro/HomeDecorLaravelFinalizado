...
<form class="d-flex" role="search" style="margin-right: 10px; margin-left: 5px">
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <button type="button" class="btn btn-secondary">
                                <a style="color: white; text-decoration: none" href="{{ route('register') }}">Cadastro</a>
                            </button>
                        @endif
                    @endauth
                </div>
    ...
    <div class="nav-scroller py-3 mb-2">
      <ul class="nav nav-underline flex nav-fill">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('promocao.index') }}" style="color: black"> Promoções</a>
        </li>
      </ul>
    </div>
  </div>
