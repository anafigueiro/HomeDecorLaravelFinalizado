...
<head>
  ...
  <title>Home decor - Contatos </title>
...
<body>
  ...
  <div class="container-justify-content-center">
    ...
    <h3 class="h3" style="text-align: center"> Lista de contatos</h3>
    <div class="card" style="padding:20px; margin-top: 20px">
        <form action="{{ route('contato.search') }}" method="post" class="row g-3">
            ...
            <div class="col-md-6">
                <select class="btn btn btn-secondary btn-sm dropdown-toggle" name="tipo" >
                    ...
                    <option value="des">Descrição</option>
                </select> 
            ...
            <button class="btn btn-secondary btn-sm">
                <a href="{{ route('contato.create') }}" style="color:white; text-decoration:none">Cadastrar</a>
            </button>
        </form>
    </div>
    <table border="1" class="table table-bordered" style="margin-top: 30px">
        ...
        @foreach ($contatos as $item)
            <tr>
                ...
                <td>{{$item->endereco}}</td>
                <td>{{$item->des}}</td>
                <td><a href="{{route('contato.edit', $item->id)}}">Editar</a></td>
                <td><a href="{{route('contato.destroy', $item->id)}}"
